...
/**
 * Represents information encoded using the AAMVA version 4 standard
 */
public class AAMVAv4DocumentData extends AAMVADocumentData {
    AAMVAv4DocumentData() throws Exception {
