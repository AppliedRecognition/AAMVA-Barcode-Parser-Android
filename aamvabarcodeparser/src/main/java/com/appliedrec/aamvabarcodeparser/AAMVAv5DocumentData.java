...
/**
 * Represents information encoded using the AAMVA version 5 standard
 */
public class AAMVAv5DocumentData extends AAMVADocumentData {

    AAMVAv5DocumentData() throws Exception {
