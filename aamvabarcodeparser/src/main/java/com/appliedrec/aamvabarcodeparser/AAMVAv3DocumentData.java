...
/**
 * Represents information encoded using the AAMVA version 3 standard
 */
public class AAMVAv3DocumentData extends AAMVADocumentData {

    AAMVAv3DocumentData() throws Exception {
