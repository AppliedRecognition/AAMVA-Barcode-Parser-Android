...
/**
 * Represents information encoded using the AAMVA version 8 standard
 */
public class AAMVAv8DocumentData extends AAMVADocumentData {

    AAMVAv8DocumentData() throws Exception {
