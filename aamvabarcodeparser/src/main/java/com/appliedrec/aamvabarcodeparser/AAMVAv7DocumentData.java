...
/**
 * Represents information encoded using the AAMVA version 7 standard
 */
public class AAMVAv7DocumentData extends AAMVADocumentData {

    AAMVAv7DocumentData() throws Exception {
